...
(cl:defmethod cl:initialize-instance :after ((m <Leds-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_fundamentals-srv:<Leds-request> is deprecated: use create_fundamentals-srv:Leds-request instead.")))

(cl:ensure-generic-function 'advance-val :lambda-list '(m))
(cl:defmethod advance-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_fundamentals-srv:advance-val is deprecated.  Use create_fundamentals-srv:advance instead.")
  (advance m))

(cl:ensure-generic-function 'play-val :lambda-list '(m))
(cl:defmethod play-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_fundamentals-srv:play-val is deprecated.  Use create_fundamentals-srv:play instead.")
  (play m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_fundamentals-srv:color-val is deprecated.  Use create_fundamentals-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_fundamentals-srv:intensity-val is deprecated.  Use create_fundamentals-srv:intensity instead.")
  (intensity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Leds-request>)))
  ...
  "create_fundamentals/LedsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Leds-request)))
  "Returns string type for a service object of type 'Leds-request"
  "create_fundamentals/LedsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Leds-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_fundamentals-srv:<Leds-response> is deprecated: use create_fundamentals-srv:Leds-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Leds-response>)))
  ...
  "create_fundamentals/LedsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Leds-response)))
  "Returns string type for a service object of type 'Leds-response"
  "create_fundamentals/LedsResponse")
